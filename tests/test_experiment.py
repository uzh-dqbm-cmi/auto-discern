...
class TestExperiment(unittest.TestCase):
    ...
    def test_partition_document_ids_all_elements_preserved(self):
        ...
        output = ade.ExperimentManager.partition_document_ids(doc_ids, 4)
    ...
    def test_materialize_partition(self):
        ...
        self.assertEqual(ade.ExperimentManager.materialize_partition(partition_ids, data_dict), expected_output)
